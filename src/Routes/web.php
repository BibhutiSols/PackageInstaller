...
Route::group(['prefix' => 'install', 'as' => 'installer::', 'namespace' => 'Bibhuti\Installer\Controllers', 'middleware' => ['install', 'web']], function () {
    Route::get('/', [
        'as' => 'welcome',
...
Route::group(['prefix' => 'update', 'as' => 'LaravelUpdater::', 'namespace' => 'Bibhuti\Installer\Controllers', 'middleware' => 'web'], function () {
